...
if("TRUE" STREQUAL "TRUE")
  set(lio_sam_SOURCE_PREFIX /home/llx/learning/LIO_SAM_ws/src/lio-sam)
  set(lio_sam_DEVEL_PREFIX /home/llx/learning/LIO_SAM_ws/devel)
  set(lio_sam_INSTALL_PREFIX "")
  set(lio_sam_PREFIX ${lio_sam_DEVEL_PREFIX})
else()
  set(lio_sam_SOURCE_PREFIX "")
  set(lio_sam_DEVEL_PREFIX "")
  set(lio_sam_INSTALL_PREFIX /home/llx/learning/LIO_SAM_ws/install)
...
if(NOT "/home/llx/learning/LIO_SAM_ws/devel/include;/home/llx/learning/LIO_SAM_ws/src/lio-sam/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(lio_sam_INCLUDE_DIRS "")
  set(_include_dirs "/home/llx/learning/LIO_SAM_ws/devel/include;/home/llx/learning/LIO_SAM_ws/src/lio-sam/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'lilinxiang <lilinxiang@tsari.tsinghua.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lio_sam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/llx/learning/LIO_SAM_ws/src/lio-sam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/llx/learning/LIO_SAM_ws/devel/lib;/opt/ros/noetic/lib)
